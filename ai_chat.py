    ...
    system_instruction = {
        "parts": [{
            "text": (
                ...
                "Пиши МАКСИМАЛЬНО КРАТКО И ЕМКО! Никаких длинных приветствий, рассуждений на 5 абзацев и пространных вступлений. "
                "Весь твой ответ должен занимать не более 2-4 коротких предложений (или 2-3 коротких пулек с эмодзи). "
                "Если спрашивают про шансы — сразу давай цифру процентов и 1-2 главных факта обоснования. Будь емким как спортивный твит!"
            )
        }]
    }
