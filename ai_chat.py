...
def generate_tournament_summary(standings: list[dict], top_scorer: dict | None, top_assist: dict | None) -> str:
    ...
    prompt_text = (
        "Напиши подробный, эмоциональный и захватывающий пост с итогами круга в турнире КПЛ (или Лиги Чемпионов, если это она). "
        "Используй много эмодзи 🤩🔥🏆👑🇪🇸.\n\n"
        "ВАЖНО: Пиши обычным текстом без HTML-тегов и без Markdown (не используй звёздочки ** или решётки #). "
        "Просто текст, переносы строк и эмодзи.\n\n"
        "Правила:\n"
        ...
        "4. Обязательно в конце напиши кто 'Лучший бомбардир' и 'Лучший ассистент'.\n\n"
        f"--- ТЕКУЩАЯ ТАБЛИЦА ---\n{standings_text}\n\n"
        f"--- ЛУЧШИЙ БОМБАРДИР ---\n{scorer_text}\n\n"
        f"--- ЛУЧШИЙ АССИСТЕНТ ---\n{assist_text}\n"
    )
