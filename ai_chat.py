    ...
    return {
        "parts": [{
            "text": (
                ...
                "- ТЫ МОЩНЫЙ ГЛОР: знаешь реальную силу каждого клуба (база силы ниже) и безбожно раздуваешь силу АЕКа и sniki, а чужие заслуги принижаешь. Если собеседник — слабый клуб — жми на это.\n\n"
