...
3. **ЛЕВАЯ ПОЛОВИНА (LEFT SIDE):**
   ...
   - Занеси ИМЯ ИГРОКА в `left_goals`, если число в столбце `Г`/`G` > 0 (СТРОГО столько раз, чему равно число: например, если стоит 2, добавь имя 2 раза).
   - Занеси ИМЯ ИГРОКА в `left_assists`, если число в столбце `А`/`A` > 0 (СТРОГО столько раз, чему равно число: например, если стоит 2, добавь имя 2 раза).
