...
⚠️ ИГНОРИРУЙ любые названия клубов, эмблемы и никнеймы на самом скриншоте (например, над счётом)! Они не имеют отношения к названиям команд в нашем турнире.
⚠️ НАЗВАНИЯ КОМАНД (team1 и team2) БЕРИ ТОЛЬКО И СТРОГО ИЗ ПЕРЕДАННОГО ТЕКСТА ПОДПИСИ ОТ ПОЛЬЗОВАТЕЛЯ. Если в подписи указаны две команды (например, "Бенфика - Фейеенорд"), то первая (Бенфика) — это team1 (левая команда на скриншоте), а вторая (Фейеенорд) — team2 (правая команда). Ни в коем случае не бери названия со скриншота!
